...
Source: https://autoarm.rhizomatics.org.uk/configuration/migration/
...
1. Populates options with calendar entities, person entities, occupancy defaults, and no-event mode from YAML
1. Continues to read advanced settings (transitions, buttons, notification profiles, etc.) from YAML
