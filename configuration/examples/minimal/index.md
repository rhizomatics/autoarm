...
Source: https://autoarm.rhizomatics.org.uk/configuration/examples/minimal/
...
For reference, the equivalent YAML-only configuration lives inside `config.yaml` or an include file set up for the `autoarm` domain.
